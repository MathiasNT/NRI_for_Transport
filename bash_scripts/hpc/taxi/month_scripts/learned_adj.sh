...
#BSUB -N
#BSUB -o ../logs/learned_taxi/%J_.out
#BSUB -e ../logs/learned_taxi/%J_.err
...
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/pretrain_learned_${PRIOR}_${NORMALIZATION}_enc${ENC_N_HID}_s${SEED} \
                        --epochs ${EPOCHS} \
