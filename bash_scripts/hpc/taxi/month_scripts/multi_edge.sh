...
#BSUB -N
#BSUB -o ../logs/mlp_taxi/%J_.out
#BSUB -e ../logs/mlp_taxi/%J_.err

EXP_NAME=final_models/taxi/month
...
PICKUP_DATA_PATH=taxi_data/full_manhattan/month_full_manhattan_2d.npy
...
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/pretrain_long_more_edges_${PRIOR}_${NORMALIZATION}_enc${ENC_N_HID}_s${SEED} \
                        --epochs ${EPOCHS} \
