##
# Script for running continuing training of a full NRI model on the NYC Yellow Taxi dataset. Note that prior is selected beneath
##
...
CHECK_POINT_PATH=../models/final_models/taxi/fixed/pretrain_long_loc_z_enc128_s42/checkpoint_model_dict.pth
...
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/pretrain_long_${PRIOR}_${NORMALIZATION}_enc${ENC_N_HID}_s${SEED} \
                        --epochs ${EPOCHS} \
