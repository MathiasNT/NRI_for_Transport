...
EXP_NAME=final_models/taxi/mlp_models_pretrain
...
#PRIOR=dtw
#PRIOR_ADJ_PATH=taxi_data/full_manhattan/train_full_manhattan_dtw_adj_bin.npy

#PRIOR=normdtw
#PRIOR_ADJ_PATH=taxi_data/full_manhattan/train_full_manhattan_norm_dtw_adj_bin.npy
