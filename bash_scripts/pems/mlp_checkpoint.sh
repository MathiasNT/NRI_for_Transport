##
# Script for continuing training of a full NRI model with a local prior for the PEMS dataset
##
...
CHECK_POINT_PATH="../models/mlp_pems/mlp_lr0.0005_s42/checkpoint_model_dict.pth"
