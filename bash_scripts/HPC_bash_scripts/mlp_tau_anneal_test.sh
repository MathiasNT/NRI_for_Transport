...
#BSUB -N
#BSUB -o ../logs/%J_Output_mlp_tau_anneal_test.out
#BSUB -e ../logs/%J_Error_mlp_tau_anneal_test.err
...
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/MLP_hard_${GUMBEL_TAU}tau_anneal \
                        --epochs ${EPOCHS} \
                        --kl_cyc ${KL_CYC} \
                        --encoder_type mlp \
                        --loss_type nll \
