...
NLL_VARIANCE=0.0005
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/uni_low_var_${SEED} \
                        --epochs ${EPOCHS} \
                        --encoder_type mlp \
                        --loss_type nll \
...
NLL_VARIANCE=0.005
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/uni_med_var_${SEED} \
                        --epochs ${EPOCHS} \
                        --encoder_type mlp \
                        --loss_type nll \
                        --cuda_device ${CUDA_DEVICE} \
...
NLL_VARIANCE=0.05	
python3 NRI_OD_train.py  --experiment_name ${EXP_NAME}/uni_high_var_${SEED} \
                        --epochs ${EPOCHS} \
                        --encoder_type mlp \
                        --loss_type nll \
                        --cuda_device ${CUDA_DEVICE} \
